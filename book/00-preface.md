...
4. **章ごとに手を動かす課題** を置く。解答は `solutions/chNN.md` に、**ヒント → 部分解答 → 完全解答** の段階で用意している。すぐに答えを見ず、自分の手を動かしてから照合する使い方を想定している。
...
本書は筆者が自分用にまとめたノートをベースにしているため、誤記や不明瞭な記述が残っている可能性があります。気づいたら [GitHub リポジトリ](https://github.com/hama-jp/drracket-japanese-tutorial) の Issue / Pull Request で教えてもらえるととても助かります。
